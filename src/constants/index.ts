import { ChainId, JSBI, Percent, Token, WETH } from 'cashcow-sdk'
// change address
// export const ROUTER_ADDRESS = '0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F'
export const ROUTER_ADDRESS = '0xf257e6ffaEE31fA01AeA3e8c5F348047a2d3009E'
...
export const WBNB = new Token(ChainId.BSCTESTNET, '0xaE8E19eFB41e7b96815649A6a60785e1fbA84C1e', 18, 'WBNB', 'Wrapped BNB')
export const DAI = new Token(ChainId.BSCTESTNET, '0x20d3aa074ff340eee382d0ae91b3ef2e3166b88c', 18, 'DAI', 'Dai Stablecoin')
...
export const USDT = new Token(ChainId.BSCTESTNET, '0xba6670261a05b8504e8ab9c45d97a8ed42573822', 18, 'USDT', 'Tether USD')
export const UST = new Token(
  ChainId.BSCTESTNET,
  '0x23396cf899ca06c4472205fc903bdb4de249d6fc',
  18,
