import { Currency, CurrencyAmount, Pair, Token, Trade } from 'cashcow-sdk'
...
function useAllCommonPairs(currencyA?: Currency, currencyB?: Currency): Pair[] {
  ...
  console.log(currencyA,currencyB,chainId,"basePairs","chainId") 
...
export function useTradeExactIn(currencyAmountIn?: CurrencyAmount, currencyOut?: Currency): Trade | null {
  console.log(currencyAmountIn?.currency,currencyOut,"hooks.currencyOut")
  const allowedPairs = useAllCommonPairs(currencyAmountIn?.currency, currencyOut)
  console.log(currencyAmountIn,currencyOut,allowedPairs.length)
