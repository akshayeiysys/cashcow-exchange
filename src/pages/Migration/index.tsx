...
import { Heading, Card, CardHeader, CardBody, Text, Button, Link, Flex, ArrowDownIcon } from 'cashcow-exchange-ui'
  ...
  return (
    <>
      <Header>
        ...
        Cashcow Defi is being upgraded! <br />
        ...
        <Wrapper>
          ...
          <Card mb="32px">
            ...
            <CardBody>
              ...
              <Button as={Link} external href="http://3.143.197.157:8000/#/pool" style={{ width: '100%' }}>
                Add liquidity
              </Button>
            </CardBody>
          </Card>
          ...
          <Card>
            ...
            <CardBody>
              ...
              <Button as={Link} external href="http://3.143.197.157/farms" style={{ width: '100%' }}>
                Go to farms
              </Button>
            </CardBody>
          </Card>
