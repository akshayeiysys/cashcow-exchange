      ...
      <CardBody>
        ...
        <Card>
          <CardBody>
            ...
            <Button as={Link} external href="http://3.143.197.157/farms/history" style={{ width: '100%' }}>
              Go to Farms
            </Button>
          </CardBody>
        </Card>
        ...
        <Card>
          ...
          <FoldableContent isVisible={isVisible}>
            <Text mb="16px">
              You may need to unstake any Cashcow LP Tokens that you’ve staked in yield aggregators or other
