...
import { Trade, TradeType } from 'cashcow-sdk'
import { Card, CardBody, Text } from 'cashcow-exchange-ui'
        ...
        <RowBetween>
          <RowFixed>
            ...
            <QuestionHelper
              text={TranslateString(
                230,
                'For each trade a 0.2% fee is paid. 0.17% goes to liquidity providers and 0.03% goes to the Cashcow treasury.'
              )}
            />
          </RowFixed>
          <Text fontSize="14px">
