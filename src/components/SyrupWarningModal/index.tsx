...
import { Button, Text } from 'cashcow-exchange-ui'
            ...
            <>
              ...
              <Text color="failure">
                {transactionType === 'Buying'
                  ? 'You will not receive COW rewards for holding purchased SYRUP.'
                  : 'You will need to buy back the same amount of SYRUP to be able to convert back to COW.'}
              </Text>
            </>
          )}
          <RowBetween>
